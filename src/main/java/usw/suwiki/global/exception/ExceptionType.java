...
public enum ExceptionType {
    ...
    EMAIL_VALIDATED_ERROR_RETRY("USER006", "이메일 인증 만료기간이 지나거나, 예기치 못한 오류로 이메일 인증에 실패했습니다. 회원가입을 다시 진행해주세요", HttpStatus.BAD_REQUEST),
    ...
    LOGIN_REQUIRED("USER011", "로그인이 필요합니다.", HttpStatus.FORBIDDEN), //403
