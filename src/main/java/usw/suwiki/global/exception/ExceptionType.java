...
public enum ExceptionType {
    ...
    USER_NOT_FOUND_BY_EMAIL("USER013", "해당 이메일에 대한 유저를 찾을 수 없습니다.", HttpStatus.BAD_REQUEST),
    USER_NOT_FOUND_BY_LOGINID("USER016", "해당 아이디에 대한 유저를 찾을 수 없습니다.", HttpStatus.BAD_REQUEST),
